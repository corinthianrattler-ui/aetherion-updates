...
(()=>{
 ...
 function installStateHooks(){
  ...
  if(typeof migrateState==='function'){const base=migrateState;migrateState=function(state,...args){let out=base.call(this,state,...args);return out&&out.meta?.v167IdentityWorld?.version!==VERSION?repairState(out):out}}
 }
