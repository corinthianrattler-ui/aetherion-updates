/* Aetherion Reforged v1.69.2 — MIME-safe channel transport, staged updates, automatic rollback, and Safe Start. */
'use strict';
(()=>{
 const VERSION='1.69.2';
 const BUNDLED_VERSION='1.69.2';
 const ANDROID_BUILD=186;
