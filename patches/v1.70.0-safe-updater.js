/* Aetherion Reforged v1.70.0 — MIME-safe channel transport, staged updates, automatic rollback, and Safe Start. */
'use strict';
(()=>{
 const VERSION='1.70.0';
 const BUNDLED_VERSION='1.70.0';
 const ANDROID_BUILD=187;
