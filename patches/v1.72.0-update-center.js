/* Aetherion Reforged v1.72.0 — menu-based update center with real transfer progress. */
'use strict';
(()=>{
 const VERSION='1.72.0';
 const ANDROID_BUILD=189;
 ...
 const runtime={modal:null,busy:false,candidate:null,lastBytes:0,lastTotal:0};
 ...
 function open(){
  ...
  route.innerHTML='<b>Where this lives</b><span>Opening Menu → GAME UPDATES</span><span>Systems → GAME UPDATES</span>';
 ...
 window.AetherionUpdateCenterV172=Object.freeze({version:VERSION,androidBuild:ANDROID_BUILD,channel:CHANNEL_DISPLAY_URL,open,close,mount,state:()=>({...state(),busy:runtime.busy,lastBytes:runtime.lastBytes,lastTotal:runtime.lastTotal})});
