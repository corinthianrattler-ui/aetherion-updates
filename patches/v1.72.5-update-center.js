/* Aetherion Reforged v1.72.5 — native-aware update center with truthful install status. */
'use strict';
(()=>{
 ...
 const APK_URL='https://github.com/corinthianrattler-ui/aetherion-updates/releases/download/v1.72.5/Aetherion_Reforged_v1.72.5_MODULAR_EQUIPMENT_UPDATE.apk';
 const NATIVE_SENTINEL='assets/v175/native-build-194.json';
 ...
 function open(){
  ...
  route.innerHTML='<b>Update path</b><span>1. Tap DOWNLOAD FULL APK.</span><span>2. Watch Android download the APK, then open it.</span><span>3. Approve Update when Android asks. Build 194 identifies itself after installation.</span>';
