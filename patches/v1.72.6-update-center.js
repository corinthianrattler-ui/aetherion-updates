/* Aetherion Reforged v1.72.6 — native-aware update center with truthful install status. */
'use strict';
(()=>{
 ...
 const APK_URL='https://github.com/corinthianrattler-ui/aetherion-updates/releases/download/v1.72.6/Aetherion_Reforged_v1.72.6_GAMEPLAY_REPAIR_FULL.apk';
 const NATIVE_SENTINEL='assets/v176/native-build-195.json';
 ...
 function open(){
  ...
  route.innerHTML='<b>Update path</b><span>1. Tap CHECK FOR UPDATE for small gameplay patches.</span><span>2. Use DOWNLOAD FULL APK only when Android files change or you need a clean reinstall.</span><span>3. Build 195 identifies itself after a full installation.</span>';
