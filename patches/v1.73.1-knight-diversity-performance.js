/* Aetherion Reforged v1.73.1 — full-body knight diversity and bounded roster rendering. */
'use strict';
(()=>{
 const VERSION='1.73.1',POLICY='full-body-knight-diversity-v1.73.1';
 if(window.AetherionV1731KnightDiversity?.version===VERSION)return;
 const ROOT='https://raw.githubusercontent.com/corinthianrattler-ui/aetherion-updates/main/custom/npc-portraits/v1731/';
 const SPECS=[
 ...
 installUpgradeGuards();installFactories();installMutations();installViews();installStateHooks();installStyles();installRecovery();
