...
assert(feed?.release?.version==='1.70.0','stable channel version was not updated');
assert(feed.release.minimumBundled==='1.70.0','stable channel does not require the current APK');
