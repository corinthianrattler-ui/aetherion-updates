...
def main() -> None:
    ...
    assert manifest["latest"]["game_version"] == "1.63.1"
    assert manifest["latest"]["android_version_code"] == 175
    ...
    print("manifest.json: 1.63.1 rollback payload sizes and SHA-256 hashes passed")
