...
def main() -> None:
    ...
    assert manifest["latest"]["game_version"] == "1.61.0"
    ...
    assert [payload["path"] for payload in payloads] == [
        ...
        "assets/v107/valkorion_modular.glb",
        "patches/v1.61.0-valkorion-modular.js",
    ]
    ...
    print("manifest.json: 1.61.0 payload sizes and SHA-256 hashes passed")
