#!/usr/bin/env python3
"""Validate the exact mobile GLBs placed in the v1.72.3 APK payload."""
...
def main() -> None:
    ...
    print("v1.72.3 mobile models: exact hashes, all 91 fitted meshes, quantization-only geometry, and double-sided surfaces passed")
